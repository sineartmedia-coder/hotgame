...
function App() {
  ...
  const [players, setPlayers] = useState({
    woman: { name: 'Oyuncu 1', score: 0, completed: 0, rejected: 0, jokers: settings.jokerCount },
    man: { name: 'Oyuncu 2', score: 0, completed: 0, rejected: 0, jokers: settings.jokerCount }
  });
  
  const [startingPlayer, setStartingPlayer] = useState(null); // 'woman' or 'man'
  ...
  return (
    <div className="app-container">
      ...
      {currentScreen === 'settings' && <Settings settings={settings} setSettings={setSettings} onNext={() => setCurrentScreen('nameEntry')} />}
